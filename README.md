...
This package has been tested on Laravel 4.1 through Laravel 9.x, though it may continue to work on later versions as they are released. This section will be updated to reflect the versions on which the package has actually been tested.
...
#### Laravel/Lumen 5.1+, 6.x, 7.x, 8.x (5.1, 5.2, 5.3, 5.4, 5.5, 5.6, 5.7, 5.8, 6.x, 7.x, 8.x, 9.x)
